...
urlpatterns = [
    ...
    path('book_accession_edit/', book_accession_edit, name='book_accession_edit'),
    path('book_accession_view/', book_accession_view, name='book_accession_view'),
    ...
    path('event_index/', event_index, name='event_index'),
