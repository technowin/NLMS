...
class tbl_librarymasterL02(models.Model):
    ...
    location = models.ForeignKey(LibraryLocationMaster, on_delete=models.SET_NULL, related_name="librariesL02", db_column="location_id", null=True, blank=True)
    parent_ward = models.ForeignKey(WardMaster, on_delete=models.SET_NULL, related_name="ward_librariesL02", db_column="ward_id", null=True, blank=True)
    library_accounting_code = models.ForeignKey(WardMaster, on_delete=models.SET_NULL, related_name="ward_accounting_codeL02", db_column="accounting_id", null=True, blank=True)
